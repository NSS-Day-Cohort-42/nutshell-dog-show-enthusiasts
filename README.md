...
1. Clone repository
1. CD to api directory in terminal
1. touch database.json
1. Delete .ignore file from api directory
1. run json-server -p 8088 -w database.json
1. In terminal cd to application directory and run serve, copy localhost address to browser
1. To view weather, you need a https://www.weatherbit.io/api API key
