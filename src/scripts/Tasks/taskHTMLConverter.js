...
export const taskHTMLCon = (task) => {
    return `
        <div class="card__task" id="taskCards">
            <input class="taskBoxCompleted" type="checkbox" id="taskCompletedChecked--${task.id}" name="taskBox">
            <label class="taskBoxComplete" for="taskBox">Completed</label>
            ...
            <button class="deleteTaskButton" id="deleteTask--${task.id}">Delete</button>
            <button class="editTaskButton" id="editTask--${task.id}">Edit</button>
        </div>
    `
}
